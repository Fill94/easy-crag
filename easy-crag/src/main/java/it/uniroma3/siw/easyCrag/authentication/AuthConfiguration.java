package it.uniroma3.siw.easyCrag.authentication;

import static it.uniroma3.siw.easyCrag.model.Credentials.ADMIN_ROLE;
import static it.uniroma3.siw.easyCrag.model.Credentials.DEFAULT_ROLE;
...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		//solo gli utenti con ruolo default possono accedere alle risorse con path /user/**
